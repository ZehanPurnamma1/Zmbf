...
# Facebook (Zehan Purnama X)   : https://www.facebook.com/zehan.purnama.3
# Whatsapp (Zehan Bot_Key)        : +628998982057
...
### Logo
_logo_line_1_ = ('%s___________________Hans___________________'%(_P_))
_logo_line_2_ = ('%s| %s┌─────────────────────────┐'%(_P_,_U_))
_logo_line_3_ = ('%s| %s│   %s• Code By Zehan •   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s| %sGithub.com/ZehanPurnamma1/Zmbf %s│'%(_P_,_U_,_P_,_U_))
